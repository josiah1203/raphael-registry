...
_db = Path(os.environ.get("RAPHAEL_REGISTRY_DB", "/tmp/raphael-registry.db"))
...
def list_items() -> dict[str, Any]:
    ...
    return {"service": "raphael-registry", "items": [{"id": r[0], "name": r[1], "body": r[2], "created_at": r[3]} for r in rows]}
